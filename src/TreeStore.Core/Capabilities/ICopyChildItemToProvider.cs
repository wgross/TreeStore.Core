...
public interface ICopyChildItemToProvider
{
    ...
    /// </summary>
    public CopyChildItemResult CopyChildItem(ICmdletProvider provider, ProviderNode nodeToCopy, PSDriveInfo destinationDrive, string destination, bool recurse);
}